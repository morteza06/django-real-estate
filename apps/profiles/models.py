...
class Gender(models.TextChoices):
    MALE = "Male", _("Male")
    FEMALE = "Emale", _("Female")
    OTHER = "Other", _("Other")
    
class Profile(TimeStampedUUIDModel):
    user = models.OneToOneField(User, related_name=_("profile"), on_delete=models.CASCADE)
    phone_number = PhoneNumberField(verbose_name=_("Phone Number"), max_length=30, default="+12125552368")
    ...
    city = models.CharField(verbose_name=_("City"), max_length=180, default="Rasht", blank=False, null=False)
    is_buyer = models.BooleanField(verbose_name=_("Buyer"), default=False, help_text=_("Are you looking to Buy a Property?"))
    is_seller = models.BooleanField(verbose_name=_("Seller"), default=False, help_text=_("Are you looking to Buy a Property?"))
