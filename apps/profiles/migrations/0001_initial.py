# Generated by Django 4.0.4 on 2022-05-02 12:16
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gender', models.CharField(choices=[('Male', 'Male'), ('Emale', 'Female'), ('Other', 'Other')], default='Other', max_length=20, verbose_name='Gender')),
                ('country', django_countries.fields.CountryField(default='IR', max_length=2, verbose_name='Country')),
                ('city', models.CharField(default='Rasht', max_length=180, verbose_name='City')),
                ('is_buyer', models.BooleanField(default=False, help_text='Are you looking to Buy a Property?', verbose_name='Buyer')),
                ('is_seller', models.BooleanField(default=False, help_text='Are you looking to Buy a Property?', verbose_name='Seller')),
