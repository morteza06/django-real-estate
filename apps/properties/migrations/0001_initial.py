# Generated by Django 4.0.4 on 2022-05-05 05:43
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('country', django_countries.fields.CountryField(default='IR', max_length=2, verbose_name='Country')),
                ('city', models.CharField(default='Rasht', max_length=100, verbose_name='City')),
                ('postal_code', models.CharField(default='140', max_length=100, verbose_name='Postal Code')),
                ('street_address', models.CharField(default='Razi Avenue', max_length=150, verbose_name='Street Address')),
                ...
                ('plot_area', models.DecimalField(decimal_places=2, default=0.0, max_digits=8, verbose_name='Ploat Area(m^2)')),
                ...
                ('cover_title', models.ImageField(blank=True, default='/house_sample.jpg', null=True, upload_to='', verbose_name='Main Photo')),
                ('photo1', models.ImageField(blank=True, default='/interior_sample1.jpg', null=True, upload_to='')),
                ('photo2', models.ImageField(blank=True, default='/interior_sample2.jpg', null=True, upload_to='')),
                ('photo3', models.ImageField(blank=True, default='/interior_sample3.jpg', null=True, upload_to='')),
                ('photo4', models.ImageField(blank=True, default='/interior_sample4.jpg', null=True, upload_to='')),
