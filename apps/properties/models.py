...
class Property(TimeStampedUUIDModel):
    ...
    country = CountryField(verbose_name=_("Country"), default="IR", blank_label="(select country)",)
    ...
    photo3 = models.ImageField(default="/interior_sample3.jpg", null=True, blank=True)
